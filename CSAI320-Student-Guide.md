...
## How to Use This Guide
This guide is written for students. It is designed to be self-contained, which means it gives students the key ideas, vocabulary, and weekly tasks they need in order to complete the course work.

Students should read each week in order.
